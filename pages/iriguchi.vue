  ...
  <v-container fluid>
    <v-data-iterator :items="posts" hide-default-footer>
      <template v-slot:header>
        <v-toolbar>
          <v-toolbar-title>入口</v-toolbar-title>
          <v-spacer></v-spacer>
...
export default {
  ...
  mounted() {
    ...
    axios.get('/entrance').then((response) => (this.posts = response.data))
    // axios.get('/api/entrance').then((response) => (this.posts = response.data))
