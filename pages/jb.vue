  ...
  <v-container fluid>
    <v-data-iterator :items="posts" hide-default-footer>
      <template v-slot:header>
        <v-toolbar>
          <v-toolbar-title>JetBot</v-toolbar-title>
          <v-spacer></v-spacer>
...
export default {
  ...
  mounted() {
    ...
    axios.get('/jetbot').then((response) => (this.posts = response.data))
    // axios.get('/api/jetbot').then((response) => (this.posts = response.data))
